...
from cryolike.star_file import read_star_file, write_star_file

def test_star_file():
    
    file_dir = Path(__file__).resolve()
    filename_in = file_dir.parent.parent.joinpath("data").joinpath("particle_data.star")
    filename_out = file_dir.parent.parent.joinpath("data").joinpath("particles_out.star")
