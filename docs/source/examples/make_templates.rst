...
In this tutorial, we will show how to make templates from
...
in the :py:mod:`cryolike.stacks` module.

This function takes as arguments a list of inputs for the cryo-EM
...
The atomic radii and atom selection are optional. If the user does not
specify the atomic radii, the function will use the default atomic
radii for each amino acid type.
